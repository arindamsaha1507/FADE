...
cp $facs_dir/$output_dir/$location$joiner$transition_scenario$datestamp$suffix $cur_dir/Results/

suffix1='-latest.csv'

cp $facs_dir/$output_dir/$location$joiner$transition_scenario$datestamp$suffix $cur_dir/Results/$location$suffix1
